...
(defn collection
  [name]
  (str "com.etzhayyim.kurashimori." name))

(def cell-specs {
  :remedy_registry {:legacy-cell "remedy-registry"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "remedy_registry")]
     :required-gates common-gates
     :trigger "manifest cell remedy_registry"
  ...
  :intake {:legacy-cell "intake"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :cooloff_check {:legacy-cell "cooloff-check"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "cooloff_check")]
     :required-gates common-gates
     :trigger "manifest cell cooloff_check"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :compose {:legacy-cell "compose"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :send {:legacy-cell "send"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "send")]
     :required-gates common-gates
     :trigger "manifest cell send"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :status_track {:legacy-cell "status-track"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :escalation {:legacy-cell "escalation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "escalation")]
     :required-gates common-gates
     :trigger "manifest cell escalation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
